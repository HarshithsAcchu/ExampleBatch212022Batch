...
public class AdvanceOne {
		...
		public static ActiTimeAdvanceOne oPage1 = null;
		public static void main(String[] args) {
			launchBrowser();navigateURL();Login();minimizeFlyoutWindow();
			CreateUser1User2User3();logout();loginUser1();logoutUser1();
...
//			minimizeFlyoutWindowUser1();
			...
			logoutAdmin();
			loginModifiedUser1();logoutModifiedUser1();
			loginModifiedUser2();logoutModifiedUser2();
			loginModifiedUser3();logoutModifiedUser3();
...
//			minimizeFlyoutWindowUser2();
		...
		private static void launchBrowser()
		{
			try
			{
				...
				oPage1 = new ActiTimeAdvanceOne(oBrowser);
